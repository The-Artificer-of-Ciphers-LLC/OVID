...
class TestVerifyDisc:
    ...
    def test_verify_unverified_disc(self, client, db_session, seeded_disc):
        ...
        resp = client.post(f"/v1/disc/{disc.fingerprint}/verify")
    ...
    def test_verify_already_verified(self, client, db_session, seeded_disc):
    ...
    def test_verify_not_found(self, client):
        ...
        resp = client.post("/v1/disc/nonexistent-fp/verify")
        assert resp.status_code == 404
        data = resp.json()
        assert data["error"] == "not_found"
        assert "request_id" in data

    def test_verify_updates_confidence(self, client, db_session, seeded_disc):
