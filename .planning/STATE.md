...
| Verification | **Phase 6 live-OAuth round-trip** (real GitHub/Google/Apple/Mastodon sign-in + confirm-gated merge + unlink) — the 3 `blocked` UAT items in `06-UAT.md`. Automated verification is green (VERIFICATION 0 FAIL, 442 api tests); only the human live-provider check is outstanding. Accepted to advance to Phase 7. | Accepted — **verify live before launch (Phase 8)** | 2026-07-07 |
