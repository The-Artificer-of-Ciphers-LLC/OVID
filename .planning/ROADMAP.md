...
- [x] 06-06-PLAN.md — Apple short-exp secret + IndieAuth router split/gating + localhost-bypass derivation (AUTH-03/10)
...
- [x] 07-03-PLAN.md — R-1 unverified-sibling structural redaction + R-2 `AUTH_WRITE_LIMIT` on `POST /v1/set` [Wave 1, tdd] (WEBUI-02, WEBUI-03)
...
- [x] 07-07-PLAN.md — settings add-provider + enumeration-safe merge banner + ProviderList parity (WEBUI-04, D-05) [Wave 2, depends 07-01/07-02, checkpoint:decision]
