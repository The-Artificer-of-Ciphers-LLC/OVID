...
- [ ] 05-01-PLAN.md — WR-02 fingerprint_registry model + register_fingerprint() wiring into attach_lookup_aliases + regression test [Wave 1, tdd] (IDENT-04)
- [ ] 05-02-PLAN.md — promote_one_disc()/promote_all_dvdread1_discs() Alembic-independent promotion logic + tests [Wave 1, tdd] (IDENT-04)
- [ ] 05-03-PLAN.md — ovid-client identify_dvd() Tier-2 (dvdread1) primary flip + tests [Wave 1, tdd] (IDENT-03)
- [ ] 05-04-PLAN.md — ARM identify_ovid.py/identify.py fingerprint_aliases fix + arm/tests/ + CI job [Wave 1, tdd] (IDENT-03)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 05-05-PLAN.md — D-03 _select_primary() + wiring into register_disc/submit_disc + mixed-fleet regression [Wave 2, depends 05-01, tdd] (IDENT-04)
...
| 5. ADR 0001 Completion — dvdread1-* Promotion | 0/7 | Planned | - |
